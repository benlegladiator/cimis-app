...
public class PunitionModule {
    ...
    private List<PunitionItem> items;
    ...
    public List<PunitionItem> getItems() { return items; }
    public void setItems(List<PunitionItem> items) { this.items = items; }
}