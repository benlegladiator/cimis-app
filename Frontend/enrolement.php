        ...
        <div class="main-content">
            <div class="container">
                ...
                <?php if (!extension_loaded('gd')): ?>
                    <div style="background: rgba(220, 53, 69, 0.9); border: 2px solid #ff4444; border-radius: 5px; color: white; padding: 15px; margin-bottom: 20px; font-weight: bold; text-align: center; box-shadow: 0 0 15px rgba(255,0,0,0.5); font-family: monospace;">
                        <i class="fa-solid fa-triangle-exclamation" style="font-size: 1.5rem; margin-right: 10px; color: #ffeb3b; vertical-align: middle;"></i>
                        <span>
                            ATTENTION : L'extension PHP GD n'est pas activée sur le serveur. La génération des codes QR est désactivée. 
                            <?php if (isset($_SESSION['gd_auto_enabled']) && $_SESSION['gd_auto_enabled']): ?>
                                <br><span style="color: #ffeb3b; text-decoration: underline;">Nous avons activé GD dans le fichier php.ini pour vous. Veuillez REDÉMARRER Apache dans votre panneau XAMPP pour appliquer ce changement.</span>
                            <?php else: ?>
                                <br>Veuillez ouvrir le Panneau de Contrôle XAMPP -> Config -> PHP (php.ini), rechercher la ligne <code style="background: #333; padding: 2px 5px; border-radius: 3px;">;extension=gd</code> et retirer le point-virgule au début, puis redémarrer Apache.
                            <?php endif; ?>
                        </span>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="hero-grid">
                        ...
                        <div class="module-card text-center" style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                            ...
                            <div class="form-group" style="margin-top: 1.5rem;">
                                ...
                                <input type="file" id="photo-upload" name="photo" accept="image/jpeg,image/jpg,image/png" class="form-control" style="display: none;">
