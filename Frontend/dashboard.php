...
<body>
    ...
    <div class="app-container">
        ...
        <?php if (!extension_loaded('gd')): ?>
            <div style="background: rgba(220, 53, 69, 0.9); border: 2px solid #ff4444; border-radius: 5px; color: white; padding: 15px; margin: 15px auto; max-width: 1200px; font-weight: bold; text-align: center; box-shadow: 0 0 15px rgba(255,0,0,0.5); font-family: monospace; z-index: 9999;">
