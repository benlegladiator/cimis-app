                ...
                <div class="module-card">
                    <div class="candidats-header">
                        ...
                        <div class="view-options">
                            <button class="btn btn-sm" onclick="toggleView('list')" id="listViewBtn" title="Vue liste">
                                <i class="fa-solid fa-list"></i>
                            </button>
                            <button class="btn btn-sm" onclick="toggleView('grid')" id="gridViewBtn" title="Vue grille">
    ...
    <script>
        ...
        function updateGradeOptions(unite) {
            ...
            const gradesByUnit = {
                ...
                'ARMÉE DE L\'AIR': ['Aviateur de 2E classe', 'Aviateur de 1E classe', 'Caporal', 'Caporal-Chef', 'Sergent', 'Sergent-Chef', 'Adjudant', 'Adjudant-Chef', 'Aspirant', 'Sous-Lieutenant (S/Lt)', 'Lieutenant (Lt)', 'Capitaine (Cne)', 'Commandant (Cdt)', 'Lieutenant-Colonel (LCL)', 'Colonel (COL)', 'Général de Brigade Aérienne', 'Général de Division Aérienne', 'Général de Corps Aérienne', 'Général d\'Armée Aérienne'],
