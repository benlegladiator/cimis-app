<?php
/**
 * API SIADOC ENVOIE - VERSION PRODUCTION
 * Ce fichier permet à SIADOC de récupérer les données des cartes CIMIS
 * Optimisé pour InfinityFree - Authentification désactivée temporairement
 */
...
switch ($action) {
    case 'help':
        sendResponse([
            ...
            'system' => 'CIMIS',
            'note' => 'Authentification temporairement désactivée pour déploiement'
        ]);
        break;
    ...
    case 'cartes':
        ...
        try {
            ...
            sendError('Erreur base de données (endpoint cartes): ' . $e->getMessage() . ' | SQL: ' . $sql . ' | Params: ' . json_encode($params));
        }
        break;
