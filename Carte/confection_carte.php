...
function estOfficier($grade) {
    ...
    // 1. Remplacer les traits d'union par des espaces
    $grade_normalise = str_replace('-', ' ', $grade_normalise);
    // 2. Remplacer les espaces multiples consécutifs par un seul espace
    $grade_normalise = preg_replace('/\s+/', ' ', $grade_normalise);
    
    // 3. Normaliser les accents (minuscules ET majuscules)
    ...
    $grade_normalise = str_replace(['ù', 'û', 'Ù', 'Û'], ['u', 'u', 'u', 'u'], $grade_normalise);
    ...
    $grades_officiers = [
        ...
        // OFFICIERS SUPERIEURS (ARMÉE DE TERRE)
        'colonel',
        'lieutenant colonel',
        'capitaine',
        'lieutenant',
        
        // OFFICIERS SUPERIEURS (ARMÉE DE L'AIR)
        'colonel',
        'lieutenant colonel',
        'capitaine',
        'lieutenant',
        ...
        // Variantes depuis enrolement.js (E majuscule)
        'enseigne de vaisseau de 1e classe',
        'enseigne de vaisseau de 2e classe',
        
        // OFFICIERS SUBALTERNES (ARMÉE DE TERRE)
        'sous lieutenant',
        
        // OFFICIERS SUBALTERNES (ARMÉE DE L'AIR)
        'sous lieutenant',
            ...
            <div class="card-verso-content">
                ...
                <div class="card-verso-body">
                    ...
                    <div class="verso-bottom-row">
                        ...
                        ?>
                        <div class="verso-qr" style="position: absolute; left: 90%; top: 60%; transform: translate(-50%, -50%); z-index: 11; display: flex; flex-direction: column; align-items: center;">
