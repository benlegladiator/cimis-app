                    ...
                    <form method="post" action="api.php?action=generate_matricules">
                        ...
                        <div style="margin-top: 20px;">
                            ...
                            <small style="margin-left: 10px;">
                                <?php echo $stats['sans_matricule_cimis']; ?> militaires peuvent être synchronisés
                            </small>
                        </div>
                    </form>
                <?php else: ?>
                    <p><a href="api.php?action=fetch_military" class="btn">
                        <i class="fa-solid fa-sync"></i> Charger les militaires depuis GESMIL2.0
                    </a></p>
                <?php endif; ?>
            </div>
