            ...
            if (matriculeMilitaire) {
                ...
                if (formatsAutorises[unite] && !formatsAutorises[unite].test(matriculeMilitaire)) {
                    const messagesFormat = {
                        'ARMÉE DE TERRE': 'Format: T17/23456 (T + année sur 2 chiffres / 4-6 chiffres)',
                        'ARMÉE DE L\'AIR': 'Format: A17/23456 (A + année sur 2 chiffres / 4-6 chiffres)',
                        'MARINE NATIONALE': 'Format: M17/23456 (M + année sur 2 chiffres / 4-6 chiffres)',
                        'GENDARMERIE NATIONALE': 'Format: 23456 ou 123456 (4 à 6 chiffres uniquement)'
                    };
